...
const MaxDrawdownChart: React.FC<ChartProps> = ({ data, assetNames, benchmarkName, colorMap }) => {
    ...
    <ResponsiveContainer width="100%" height={400}>
      <BarChart data={chartData} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
        ...
        {orderedAssets.map((asset) => (
          <Bar key={asset} dataKey={asset} name={asset} fill={colorMap.get(asset) || '#ef4444'} radius={[4, 4, 0, 0]} />
        ))}
      </BarChart>
    </ResponsiveContainer>
  );
